	...
	public class Tap_Open_Door : MonoBehaviour
	{
		...
		private void FingerTap(LeanFinger finger)
		{
            ...
            if (tappedObject != null)
            {
                ...
                if (doorsOpen == false)
                {
                    door_front_l = this.gameObject.transform.GetChild(3);
                    door_front_l.transform.localRotation *= Quaternion.Euler(0, 0, 50);

                    door_front_r = this.gameObject.transform.GetChild(4);
                    ...
                    door_back_l = this.gameObject.transform.GetChild(5);
                    ...
                    door_back_r = this.gameObject.transform.GetChild(6);
